...
import { playSuccessSound, playErrorSound, playCelebrationSound, speak } from '../utils/soundUtils';
...
const ShapeMatch = () => {
  ...
  const generateRound = () => {
    const numShapes = levels[level];
    const shuffled = [...shapes].sort(() => Math.random() - 0.5);
    const selected = shuffled.slice(0, numShapes);
  ...
  const finishGame = async () => {
    ...
    speak('Amazing work! You finished the game!');
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">
                Match the correct shape and color!
              </p>
            </div>
            ...
            {gameStarted && !gameComplete && (
              <div className="flex gap-4">
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-purple-600">{round}/{maxRounds}</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-blue-600">{correct}/{attempts}</p>
                </div>
              </div>
            )}
          </div>
      ...
      <div className="max-w-4xl mx-auto">
        {!gameStarted ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <button
              onClick={startGame}
              className="px-12 py-6 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-2xl font-bold rounded-2xl hover:from-purple-700 hover:to-blue-700 transition shadow-lg"
            >
              Start Playing! 🎮
            </button>
          </div>
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-xl font-bold rounded-xl hover:from-purple-700 hover:to-blue-700 transition"
              >
                Play Again 🔄
              </button>
              <button
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-xl font-semibold text-purple-600 mt-4 capitalize">
                {targetShape?.name}
              </p>
            </motion.div>
              ...
              <AnimatePresence>
                {options.map((shape, index) => (
                  <motion.button
                    ...
                    className="bg-white rounded-2xl shadow-lg p-12 hover:shadow-2xl transition-all"
                  >
