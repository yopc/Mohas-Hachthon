            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'An invitation email will be sent to the coach to set their password.',
...
Future<void> _submitForm() async {
  if (_formKey.currentState!.validate()) {
    ...
    try {
      ...
      print('Profile picture: ${_profilePicture?['base64']?.substring(0, 50)}...');
      print('Certification file: ${_certificationFile?['base64']?.substring(0, 50)}...');
      print('Has certification: $_hasCertification');
      ...
      final coach = CoachModel(
        ...
        profilePictureBase64: _profilePicture?['base64'], // This should now have value
     ...
     certificationBase64: _hasCertification ? (_certificationFile != null ? _certificationFile!['base64'] : null) : null,
     certificationFileName: _hasCertification ? (_certificationFile != null ? _certificationFile!['fileName'] : null) : null,
        region: _selectedRegion ?? '',
        zone: _zoneController.text,
        accountStatus: _selectedAccountStatus ?? 'Active',
        assignedSupervisor: _selectedSupervisor ?? '',
        role: 'coach',
        canCreateEnterprises: true,
        securityId: null,
      );
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Invitation sent to ${coach.email}. Coach ID: $coachId',
                    overflow: TextOverflow.ellipsis,
                  ),
                ),
              ],
